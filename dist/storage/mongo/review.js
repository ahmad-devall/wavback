...
class ReviewStorage {
    constructor() {
        this.scope = 'storage.review';
    }
    findAll(query) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const dbObj = yield Review_1.default.find(Object.assign({}, query));
                return dbObj;
            }
            catch (error) {
    ...
    findOne(query) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let dbObj = yield Review_1.default.findOne(Object.assign({}, query));
                if (!dbObj) {
    ...
    create(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let dbObj = yield Review_1.default.create(payload);
                return dbObj;
            }
            catch (error) {
    ...
    delete(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let dbObj = yield Review_1.default.findByIdAndDelete(id);
                if (!dbObj) {
