...
exports.FeaturesStorage = void 0;
const Features_1 = __importDefault(require("../../models/Features"));
const logger_1 = require("../../config/logger");
const appError_1 = __importDefault(require("../../utils/appError"));
class FeaturesStorage {
    constructor() {
        this.scope = 'storage.features';
    }
    findAll(query) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const dbObj = yield Features_1.default.find(Object.assign({}, query));
                return dbObj;
            }
            catch (error) {
    ...
    findOne(query) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let dbObj = yield Features_1.default.findOne(Object.assign({}, query));
                if (!dbObj) {
                    logger_1.logger.warn(`${this.scope}.get failed to findOne`);
                    throw new appError_1.default(404, 'Features_404');
                }
                return dbObj;
            }
            catch (error) {
    ...
    create(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let dbObj = yield Features_1.default.create(payload);
                return dbObj;
            }
            catch (error) {
    ...
    update(id, payload) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let dbObj = yield Features_1.default.findByIdAndUpdate(id, payload, {
                    new: true
                });
                if (!dbObj) {
    ...
    updateMany(query, payload) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const db_res = yield Features_1.default.updateMany(query, payload);
                return db_res;
            }
            catch (error) {
                logger_1.logger.error(`${this.scope}.update: finished with error: ${error}`);
    ...
    delete(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let dbObj = yield Features_1.default.findByIdAndDelete(id);
                if (!dbObj) {
...
exports.FeaturesStorage = FeaturesStorage;
